  ...
  return (
    <main className="min-h-screen p-4 md:p-8 flex flex-col gap-4 max-w-[1600px] mx-auto">
      ...
      <header className="flex justify-between items-end pb-4 border-b border-[var(--border)]">
        <div>
          <h1 className="text-xl font-medium tracking-tight text-[var(--foreground)]">Caluna</h1>
          <p className="text-xs text-[var(--text-subtle)] uppercase tracking-widest mt-1">Vision System v1.0</p>
        </div>
        <div className="flex items-center gap-4">
          <ThemeToggle />
          <SettingsPanel piIp={piIp} setPiIp={setPiIp} />
          <div className="flex items-center gap-2 px-3 py-1 bg-[var(--background)] rounded-full border border-[var(--border)]">
