...
while True:
    ...
    polygon = np.array([[
        ...
        (int(width*5), int(height*0.4)),      # kanan atas
        (int(width*0), int(height*0.4))       # kiri atas
    ]], np.int32)
    ...
    # gambar area putihnya (blok penuh)
    hasil = frame.copy()
    
    # Visualisasi ROI (garis biru)
